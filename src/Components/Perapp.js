    ...
    <div className="container-fluid">
        ...
        <div className="table-responsive">
            <table className="table container" id="Info">
                ...
                <tr>
                    <td>Name1</td>
                    <td><button style={{color:"black",backgroundColor:"white"}}type="button" className="btn btn-success" data-bs-toggle="modal" data-bs-target="#myModal">view details</button></td>
                </tr>
                <tr>
                    <td>Name1</td>
                ...
                <div className="modal-content">
                    ...
                    <table className="table-bordered" id="Info">
                        <table className=" table table-striped table-light">
                            ...
                            <tr>
                                <th>License number:</th><td></td>
                            </tr>
                            <tr>
                                <th>RC number:</th><td></td>
                            </tr>
                            <tr>
                                <th>Departure Date:</th><td></td>
                            </tr>
                            <tr>
                                <th>Reason:</th><td></td>
                            </tr>
                            <tr>
                                <th>Desired permit:</th><td></td>
                            </tr> 
                        </table>
                    </table>
                    </div>
